...
<style type="text/css">
  ...
  textarea#jobDescription, textarea#specialRequest {
    resize: none;
  }
</style>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class='input-group date'>
                  <input type='text' class="form-control" id='dateRequest'/>
                    <span class="input-group-addon">
                        <span class="fa fa-calendar"></span>
                    </span>
                </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <input type="text" class="form-control" id="specialRequest" />
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <label for="jobDescription">Job Description</label>
              <textarea class="form-control" rows="2" id="jobDescription"></textarea>
            </div>
          </div>
        </div>
      </form>
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="btn-save"><span class="fa fa-save"></span>&nbsp;Save</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div>
