	...
	<div id="top-con" class="container-fluid ">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav" id="nav-menu">
				<li>
					<a href="${pageContext.request.contextPath}/applicant" id="applicantPage">
				...
				<sec:authorize access="hasAnyRole('ROLE_HR','ROLE_ADMIN')">
					<li>
						<a href="${pageContext.request.contextPath}/approve" id="approvePage">
							<spring:message code="request.approve" />
						</a>
					</li>
				</sec:authorize>
				<li>
				...
				<li class="dropdown emailPage" id="email-dropdown">
					<a  href="#" class="dropdown-toggle emailPage" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" 
						id="btn_email" data-toggle="tooltip" data-placement="right" title="<spring:message code="warning.appointment" />">
						<spring:message code="request.email" /> <span class="badge" id="email-badge"></span> <span class="caret"></span>
					</a>
					<ul class="dropdown-menu sub-menu" id="sub-menu-email">
						<li>
							<a href="${pageContext.request.contextPath}/email/create" id="emailCreatePage">
